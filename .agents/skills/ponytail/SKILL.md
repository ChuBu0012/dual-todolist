...
trigger: >
  Use ONLY when the user explicitly says "ทำง่ายๆ", "make it easy", "make it simple",
  "ponytail", "be lazy", "lazy mode", "simplest solution", "minimal solution",
  "yagni", "do less", or "shortest path". Do NOT use for general coding tasks unless
  one of these phrases is present. Do NOT use for non-coding requests.
